...
ANOTHER IMPORTANT NOTE: Consider using the MUI Stack component instead of the Box component with display: 'flex'. Also, whenever you're using the Grid component, evaluate whether Grid or Stack is more appropriate for your use case.